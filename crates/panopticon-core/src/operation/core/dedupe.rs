...
/// Built-in operation that removes duplicate entries from an array,
/// preserving the order of first occurrence.
///
/// **Inputs:**
/// - `array` (Array, required) — the array to deduplicate.
/// - `name` (Text, optional) — the output variable name (default
///   `result`).
///
/// **Outputs:**
/// - An operation-scoped array output containing one copy of each
///   distinct entry from `array`.
